 ...
 */
final class Version20231116191557 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE transaction (id INT AUTO_INCREMENT NOT NULL, book_id INT NOT NULL, storage_id INT NOT NULL, price NUMERIC(10, 2) NOT NULL, date DATETIME NOT NULL, INDEX IDX_723705D116A2B381 (book_id), INDEX IDX_723705D15CC5DB90 (storage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
