...
final class Version20231005201618 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sale (id INT AUTO_INCREMENT NOT NULL, book_id INT NOT NULL, date DATETIME NOT NULL, price NUMERIC(10, 2) NOT NULL, INDEX IDX_E54BC00571868B2E (book_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
